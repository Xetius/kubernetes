...
func (s *Cloud) getLoadBalancerCname(service *api.Service) string {
...
func (s *Cloud) updateLoadBalancerCnameEntry(service *api.Service, dnsName *string, action string) error {
	hostedZone := getLoadBalancerHostedZone(service)
	if hostedZone == "" {
		return nil
	}
...
func (s *Cloud) addLoadBalancerCnameEntry(service *api.Service, dnsName *string) error {
	return s.updateLoadBalancerCnameEntry(service, dnsName, "UPSERT")
}

func (s *Cloud) removeLoadBalancerCnameEntry(service *api.Service, dnsName *string) error {
